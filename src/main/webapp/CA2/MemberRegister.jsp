...
<nav class="navbar bg-light navbar-light navbar-expand-lg sticky-top">
		...
		<!--Hamburger menu-->
      	...
      	<div class="collapse navbar-collapse" id="TogglerNav">
			...
			<a class="nav-item nav-link active" href="MemberRegister.jsp" style="display : <%out.println(toDisplay);%>">REGISTER</a> 
			<a class="nav-item nav-link" href="Logout.jsp" style="display : <%out.println(toLogout);%>">LOGOUT</a>
		</div>
</nav>


<h1 id="registerTitle" class="d-flex justify-content-center">REGISTER</h1>
<div class="d-flex align-items-center justify-content-center">
	...
	%>
		...
		<div class="d-flex flex-column justify-content-center">
			<button type="submit" name="btnSubmit" class="btn btn-secondary" id="RegisterButton">Register</button>
		</div>
</form>
</div>
