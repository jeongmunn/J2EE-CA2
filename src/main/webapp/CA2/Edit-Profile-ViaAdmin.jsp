...
<title>Edit Profile (Administrator Way)</title>
</head>
...
try{
	...
	response.sendRedirect("Customer-Management.jsp?errCode=invalidFoodId");
	return;
}
if(session.isNew()){
...
<div class="d-flex align-items-center justify-content-center">
	<form method="POST" action="../EditProfileAdmin?userid=<%out.println(userid);%>">  
	<%
