...
<div class="d-flex justify-content-center">
	...
	<%
		...
		if(quantity!=null){
			out.print("<div class=\"d-flex justify-content-center\">Product added to cart successfully !</div><br><br>");
		}
	...
	<%
		for(int i=0 ; i< foodlist.size() ; i++){
			...
			out.println("<p>Price : $"+ food.getRetailPrice() + "</p>");
			out.println("<p>Stock : "+ food.getStock() + "</p>");
			out.println("<p>Detail description : "+ food.getDetailDesc() + "</p>");
			out.println("<a style=\"display : " + cartButton + " \" href=\"../LoadAllFood?foodid="+ food.getFoodId() +"&&page=listing\" class=\"btn btn-outline-primary\" role=\"button\">Add to cart</a>");
			out.println("</div>");
			out.println("</div>");
			//out.println("<a href=\"Cart.jsp?id="+ food.getFoodId() +"\" class=\"btn btn-outline-danger\" role=\"button\">Add to cart</a>");
